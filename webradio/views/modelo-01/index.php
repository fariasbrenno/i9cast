        ...
        -->
                    ...
                    <?php if ($link_google_play == ''): ?>
                        ...
                        <?php else: ?>
                            ...
                            -->  
                            <!-- BAIXAR APLICATIVO -->  
                        <div id="sumir-baixar-app">
                            <div class="d-j-a w-100">
                                <button id="install-button" style="border-radius: 30px; background-color: #c40233; color: #fff; font-family: verdana" class="btn btn-warning w-100 fs-4">Baixar App <i class="fa-solid fa-circle-arrow-down" style="color:#fff"></i></button>
                            </div>
                        </div>
                    </div>                                       
                </div>
