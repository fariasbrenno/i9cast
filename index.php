...
<body>
  <!--Header,menu,nav-->
  <header>
    <nav class="navbar has-shadow" role="navigation" aria-label="main navigation" id="nav-menu">
  ...
  <!--Main-->
  <main>
    <section class="container"> <!--Seção primeiros passos-->
      <h1 class="title is-3 mt-6">Comece por aqui</h1>
      <div class="columns">
    ...
    <section class="container">
      <h1 class="title is-4 mt-5">Playlists - Video Aulas</h1>
      <div class="columns">
